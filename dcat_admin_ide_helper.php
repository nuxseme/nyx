...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection suggest
     * @property Grid\Column|Collection wiki
     ...
     * @method Grid\Column|Collection suggest(string $label = null)
     * @method Grid\Column|Collection wiki(string $label = null)
     ...
     * @property Show\Field|Collection suggest
     * @property Show\Field|Collection wiki
     ...
     * @method Show\Field|Collection suggest(string $label = null)
     * @method Show\Field|Collection wiki(string $label = null)
